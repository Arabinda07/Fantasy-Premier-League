...
# Known team code maps for earlier seasons where teams.csv was absent
HISTORICAL_TEAM_CODES = {
...
def compile_history(db_path: Path, include_active: bool = False, skip_gws: bool = False) -> None:
